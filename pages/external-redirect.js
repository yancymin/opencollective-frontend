        ...
        {isReady ? (
          <StyledCard maxWidth={450}>
            <Container p={3}>
              ...
              <P fontSize="14px" lineHeight="18px" my={3}>
                <FormattedMessage
                  ...
                  values={{ redirect: <strong>{query.url}</strong> }}
                />
              </P>
            </Container>
...
ExternalRedirectPage.propTypes = {
  /** An internal link to fallback to when user click on "Cancel". Defaults to '/' */
